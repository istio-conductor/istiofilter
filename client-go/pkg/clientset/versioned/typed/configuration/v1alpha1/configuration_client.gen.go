...
// ConfigurationV1alpha1Client is used to interact with features provided by the configuration.istio-conductor.org group.
type ConfigurationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConfigurationV1alpha1Client) IstioFilters(namespace string) IstioFilterInterface {
